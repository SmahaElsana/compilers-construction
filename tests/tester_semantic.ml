...
{input = ScmApplic  (ScmLambdaSimple (["x"], 
   ScmIf (ScmApplic (ScmVar "x", [ScmConst (ScmNumber (ScmRational(88,1)))]),
    ScmApplic (ScmVar "x", [ScmConst (ScmNumber (ScmRational(88,1)))]), 
    ScmApplic      (ScmLambdaSimple (["x"], ScmSet (ScmVar "x", ScmConst (ScmNumber (ScmRational(88,1))))),
    [ScmConst (ScmNumber (ScmRational(88,1)))]))),
      [ScmLambdaSimple (["x"], ScmVar "x")]);
       expected = 
       ScmApplic'  (ScmLambdaSimple'  (["x"],
          ScmIf'     
          (ScmApplic'  
          (ScmVar'  
          (VarParam ("x", 0)), 
          [ScmConst'  (ScmNumber (ScmRational(88,1)))]),
          ScmApplicTP'  (ScmVar'  (VarParam ("x", 0)),
          [ScmConst'  (ScmNumber (ScmRational(88,1)))]),
          ScmApplicTP'      
          (ScmLambdaSimple'  (["x"],       
          ScmSet'  
          (VarParam ("x", 0), ScmConst'  (ScmNumber (ScmRational(88,1))))),     
          [ScmConst'  (ScmNumber (ScmRational(88,1)))]))), [ScmLambdaSimple'  (["x"], ScmVar'  (VarParam ("x", 0)))]);
          name = "RON_Test_Converted 3"};




{input = ScmLambdaSimple (["x"],  ScmOr   [ScmApplic     (ScmLambdaOpt (["y"], "z",       ScmApplic        (ScmLambdaSimple ([],          ScmApplic (ScmLambdaSimple ([], ScmApplic (ScmVar "+", [ScmVar "x"; ScmVar "z"])), [])),        [])),     [ScmVar "x"; ScmConst (ScmNumber (ScmRational(98,1)))]);    ScmLambdaSimple ([], ScmSet (ScmVar "x", ScmVar "w")); ScmApplic (ScmVar "w", [ScmVar "w"])]); 
expected = 
ScmLambdaSimple'  
(["x"], ScmSeq'   
...
ScmApplicTP'  
(ScmVar'  (VarFree "+"),               
[ScmBoxGet'  (VarBound ("x", 2, 0)); ScmVar'  (VarBound ("z", 1, 1))])),            
[])),         
[])),      
[ScmBoxGet'  (VarParam ("x", 0)); ScmConst'  (ScmNumber (ScmRational(98,1)))]);     
ScmLambdaSimple'  ([], ScmBoxSet'  (VarBound ("x", 0, 0), ScmVar'  (VarFree "w")));     
ScmApplicTP'  (ScmVar'  (VarFree "w"), [ScmVar'  (VarFree "w")])]]);
name = "RON_Test_Converted 4"};

{input = ScmIf (ScmApplic (ScmLambdaSimple (["y"], ScmVar "x"), []),  ScmApplic   (ScmLambdaSimple (["x"],     ScmSeq      [ScmSet (ScmVar "x", ScmVar "y");       ScmLambdaSimple ([], ScmSet (ScmVar "x", ScmConst (ScmNumber (ScmRational(47,1)))))]),   [ScmConst (ScmSymbol "a")]),  ScmLambdaSimple (["x"], ScmSet (ScmVar "x", ScmVar "y"))); 
expected = 
ScmIf'  
(ScmApplic'  
(ScmLambdaSimple'  
...
(["x"],    
ScmSeq'      
[ScmSet'  (VarParam ("x", 0), ScmVar'  (VarFree "y"));      
ScmLambdaSimple'  
([],       
ScmSet'  
(VarBound ("x", 0, 0), 
ScmConst'  
(ScmNumber (ScmRational(47,1)))))]),  
[ScmConst'  (ScmSymbol "a")]), 
ScmLambdaSimple'  
(["x"], ScmSet'  
(VarParam ("x", 0), ScmVar'  
(VarFree "y"))));
name = "RON_Test_Converted 5"};
...
ScmSeq       
[ScmVar "x";        
ScmLambdaOpt ([], "y", ScmSet (ScmVar "y", ScmConst (ScmNumber (ScmRational(53,1)))))])),   
[])); 
...
ScmLambdaSimple (["x"; "y"],  
ScmSeq   
[ScmApplic (ScmVar "x", [ScmVar "y"]);    
ScmLambdaSimple ([],     
ScmLambdaSimple ([],      
ScmLambdaSimple ([],       
ScmSet (ScmVar "x",        
ScmApplic 
(ScmLambdaSimple (["z"], ScmSet (ScmVar "y", ScmVar "x")), [ScmVar "y"])))))]); 
expected = 
ScmLambdaSimple'  
(["x"; "y"], 
ScmSeq'   
...
[ScmApplic'  
(ScmBoxGet'  
(VarParam ("x", 0)), [ScmBoxGet'  (VarParam ("y", 1))]);     
ScmLambdaSimple'  ([],      
ScmLambdaSimple'  ([],       
ScmLambdaSimple'  ([],        
...
[ScmBoxGet'  (VarBound ("y", 2, 1))])))))]]);
name = "RON_Test_Converted 8"};
